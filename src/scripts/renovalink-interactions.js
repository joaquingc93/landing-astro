...
class RenovaLinkInteractions {
  ...
  setupIntersectionObserver() {
    ...
    const serviceCards = document.querySelectorAll(
      ".service-card, .service-card-enhanced"
    );
    ...
    const galleryItems = document.querySelectorAll(
      ".gallery-item, .gallery-item-enhanced"
    );
  ...
  createGalleryModal() {
    ...
    modal.className =
      "fixed inset-0 z-modal bg-neutral-900/95 backdrop-blur-md flex items-center justify-center p-4 opacity-0 invisible transition-all duration-300";
  ...
  async submitForm(form) {
    const submitButton = form.querySelector(
      '.form-submit-btn, button[type="submit"]'
    );
  ...
  showFormSuccess(form) {
    ...
    message.className =
      "bg-success-50 border border-success-200 text-success-800 px-6 py-4 rounded-lg mb-6 animate-fade-in-down";
    message.innerHTML = `
  ...
  showFormError(form, errorText) {
    const message = document.createElement("div");
    message.className =
      "bg-error-50 border border-error-200 text-error-800 px-6 py-4 rounded-lg mb-6 animate-fade-in-down";
    message.innerHTML = `
      <div class="flex items-center">
